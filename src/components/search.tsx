...
export const SearchInput = ({ defaultValue }: iDefault) => {
  ...
  return (
    <div className="capitalize search__input border-[2px] border-solid border-slate-500 flex flex-row items-center gap-5 p-1 rounded-[15px] mx-8">
      <label htmlFor="inputId" className="px-4">searchIcon</label>
